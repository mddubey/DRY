...
describe('Game', function() {
	...
	var gameSetup = function(game, controller) {
		var shapeData = {
			"height": 400,
			"width": 400,
			"nodesData": [
		...
		game.shapesData = [shapeData];
		game.shape = new Game.prototype.Shape(game.shapesData[0]);
		game.controller.onShapeReady(game.shape);
	};
